...
const openMetacritic = () => {
  Linking.openURL('https://www.metacritic.com/movie/a-haunting-in-venice/user-reviews/');
};

// Rotten Tomatoes로 이동하는 함수
const openRottenTomatoes = () => {
  Linking.openURL('https://www.rottentomatoes.com/m/a_haunting_in_venice/reviews?intcmp=rt-scorecard_tomatometer-reviews');
};

// IMDb로 이동하는 함수
const openIMDb = () => {
  Linking.openURL('https://www.imdb.com/title/tt22687790/reviews/?ref_=tt_ov_rt');
};
